	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico-speaker':
				...
				playAnim('shoot1');
			case 'ego-skippa':			
				frames = Paths.getSparrowAtlas('characters/EgoSkippa');
				animation.addByPrefix('idle', 'Skipper Idle', 24, false);
				animation.addByPrefix('singUP', 'Skipper Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Skipper Right', 24, false);
				animation.addByPrefix('singDOWN', 'Skipper Down', 24, false);
				animation.addByPrefix('singLEFT', 'Skipper Left', 24, false);
				playAnim('idle');	
			case 'skippa':			
				frames = Paths.getSparrowAtlas('characters/skippa');
				animation.addByPrefix('idle', 'Skipper Idle', 24, false);
				animation.addByPrefix('singUP', 'Skipper Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Skipper Right', 24, false);
				animation.addByPrefix('singDOWN', 'Skipper Down', 24, false);
